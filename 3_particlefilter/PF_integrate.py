...
class robot:
    ...
    def move(self, motion): # Do not change the name of this function
        ...
        if beta > 0.001:
            R = D / beta
            self.x += R * (sin(self.orientation + beta) - sin(self.orientation))
            self.y += R * (cos(self.orientation) - cos(self.orientation + beta))
        ...
        # unable to directly return the "self robot"
        # should generate a new robot and assign the new location parameters
        local_robot = robot()
        local_robot.set_noise(bearing_noise, steering_noise, distance_noise)
        local_robot.set(x, y, theta)
        return local_robot 
    # --------
    # sense: 
    #    
    ...
    # according to
    #           self.bearing_noise
    def sense(self, add_noise): #do not change the name of this function
        Z = []
